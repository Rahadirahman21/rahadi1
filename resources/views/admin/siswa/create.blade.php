    ...
    <div class="bg-white shadow-lg rounded-xl p-6">
        ...
        <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                {{-- Akun Siswa --}}
                <div>
                    <h2 class="text-lg font-semibold mb-4 text-gray-700">Akun Siswa</h2>
                ...
                {{-- Data Siswa --}}
                <div>
                    <h2 class="text-lg font-semibold mb-4 text-gray-700">Data Siswa</h2>

                    <div class="mb-4">
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Foto Siswa</label>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nis"
                            class="w-full px-3 py-2 border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('nis') border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        <label for="hp" class="block text-sm font-medium text-gray-700 mb-1">No. HP</label>
                        <input type="text" name="hp"
                            class="w-full px-3 py-2 border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('hp') border-red-500 @enderror"
